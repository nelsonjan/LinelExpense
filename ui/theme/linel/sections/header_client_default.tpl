        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="row border-bottom">
                <nav class="navbar navbar-fixed-top white-bg" role="navigation" style="margin-bottom: 0">
                    ...
                    <img class="logo" style="max-height: 40px; width: 145px; margin-top: 12px; margin-bottom: 10px;" src="{$app_url}application/storage/system/logo.jpg" alt="Logo">
            ...
            <div class="row wrapper page-heading">
                <div class="col-lg-12">
                    <h2 style="color: #2F4050; font-size: 16px; font-weight: 700; margin-top: 18px">{$_st} </h2>
